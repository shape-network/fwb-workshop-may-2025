            ...
            <header className="border-b">
              <div className="container mx-auto flex h-16 items-center justify-between px-4">
                ...
                <div className="flex items-center gap-4">
                  <Link
                    href="https://assembly.otom.xyz/"
                    target="_blank"
                    rel="noreferrer"
                    className="text-muted-foreground hover:text-foreground hidden text-sm sm:flex"
                  >
                    Assembly (Testnet)
                  </Link>
                  <Link
                    href="https://assembly-rho.vercel.app/"
                    target="_blank"
                    rel="noreferrer"
                    className="text-muted-foreground hover:text-foreground mr-2 hidden text-sm sm:flex"
                  >
                    Assembly (Mainnet)
                  </Link>
                  <ThemeToggle />
            ...
            <footer className="border-t py-6 md:py-0">
              <div className="container mx-auto flex items-center justify-between gap-4 px-4 sm:h-16">
                <Link
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="text-muted-foreground hover:text-foreground text-center text-left text-sm leading-loose"
                >
                  shape.network
                </Link>
